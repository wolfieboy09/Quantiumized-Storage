package dev.wolfieboy09.qtech.integration.jei.disk_assembeler;
...
public class DiskAssemblerCategory implements IRecipeCategory<DiskAssemblerRecipe> {
    public static final RecipeType<DiskAssemblerRecipe> RECIPE_TYPE = RecipeType.create(QuantiumizedTech.MOD_ID, "disk_assembler", DiskAssemblerRecipe.class);
    ...
    public DiskAssemblerCategory(@NotNull IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(QTBlocks.DISK_ASSEMBLER.get()));
    }
    ...
    public Component getTitle() {
        return QTBlocks.DISK_ASSEMBLER.get().getName();
    }
