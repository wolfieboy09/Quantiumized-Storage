package dev.wolfieboy09.qtech.integration.jei.smeltery;
...
public class SmelteryCategory implements IRecipeCategory<SmelteryRecipe> {
    public static final RecipeType<SmelteryRecipe> RECIPE_TYPE = RecipeType.create(QuantiumizedTech.MOD_ID, "smeltery", SmelteryRecipe.class);
    ...
    public SmelteryCategory(@NotNull IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(QTBlocks.SMELTERY.get()));
    }
    ...
    public @NotNull Component getTitle() {
        return QTBlocks.SMELTERY.get().getName();
    }
