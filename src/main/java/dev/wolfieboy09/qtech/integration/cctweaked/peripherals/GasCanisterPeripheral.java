...
public class GasCanisterPeripheral extends SimplePeripheralId {
    @LuaFunction(mainThread = true)
    public final ItemStackHandler getInventory(GasCanisterBlockEntity gasCanister) {
        return gasCanister.getInventory();
    }

    @LuaFunction(mainThread = true)
    public final GasCanisterState getCanisterState(GasCanisterBlockEntity gasCanister) {
        return gasCanister.getState();
    }

    @LuaFunction(mainThread = true)
    public final GasTank getTank(GasCanisterBlockEntity gasCanister) {
