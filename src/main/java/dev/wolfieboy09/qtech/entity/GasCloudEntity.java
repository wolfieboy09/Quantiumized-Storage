package dev.wolfieboy09.qtech.entity;
...
import dev.wolfieboy09.qtech.particles.GasParticleOptions;
...
public class GasCloudEntity extends AreaEffectCloud {
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide) {
            ...
            serverLevel.sendParticles(new GasParticleOptions(QTParticleTypes.GAS_PARTICLE.get(), new GasStack(this.gas)), this.getX(), this.getY(), this.getZ(), 1500, this.gas.getGasData().gasRange(), this.gas.getGasData().gasRange(), this.gas.getGasData().gasRange(), this.gas.getGasData().particleSpeed());
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        this.gas = QTRegistries.GAS.get(ResourceLocation.parse(tag.getString("Gas")));
